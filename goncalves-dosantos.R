...
resources<-c(4,3,4,3,3,4,2,2,3,2)
resources<-c(4,3,4,3,3,4,2,2,5,2)
resources<-c(2,3,4,3,3,4,2,2,5,2)
...
observed.duration<-c(8,3,2,5,2,6,4,6,4,5.5)
cost.function<-function(x){return(max(x-8.5,0))}
